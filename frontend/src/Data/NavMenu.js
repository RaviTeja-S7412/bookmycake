...
const NavBarItems = [
    {
        id: 1, label: "Christmas Specials", path: "/",
        
    },
    {
        id: 2, label: "Indian Fusion Cakes", path: ""
    },
    {
        id: 3, label: "Photo Cakes",
        subItems: [
            { id: 31, label: "All Photo Cakes", path: "" },
    ...
    },
    {
        id: 4, label: "Flavor",
        subItems: [
            { id: 41, lable: "Pineapple Cakes", path: "" },
    ...
    {
        id:10,label:"Corportate Cakes",path:""
    }
